...
| [aws_iam_role.s3_logging_bucket_accessrole](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role_policy_attachment.attach_log](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_s3_bucket_server_side_encryption_configuration.accesslogbucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_server_side_encryption_configuration) | resource |
| [aws_s3_bucket_server_side_encryption_configuration.this](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_server_side_encryption_configuration) | resource |
| [aws_s3_bucket_versioning.accesslogbucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_versioning) | resource |
| [aws_s3_bucket_versioning.this](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_versioning) | resource |
| [aws_s3_bucket_website_configuration.this](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_website_configuration) | resource |
| [random_id.server](https://registry.terraform.io/providers/hashicorp/random/3.5.1/docs/resources/id) | resource |
...
| <a name="input_create_logging_bucket"></a> [create\_logging\_bucket](#input\_create\_logging\_bucket) | Controls if S3 bucket should be created | `bool` | `false` | no |
...
| <a name="input_logging_bucket_list"></a> [logging\_bucket\_list](#input\_logging\_bucket\_list) | A map of buckets with their ID and target prefix to enable server access logging | <pre>map(object({<br>    bucket_id     = string<br>    target_prefix = string<br>  }))</pre> | `{}` | no |
| <a name="input_logging_bucket_name"></a> [logging\_bucket\_name](#input\_logging\_bucket\_name) | Name of the S3 Bucket | `string` | `""` | no |
| <a name="input_logging_bucket_server_side_encryption_configuration"></a> [logging\_bucket\_server\_side\_encryption\_configuration](#input\_logging\_bucket\_server\_side\_encryption\_configuration) | Map containing server-side encryption configuration. | `any` | `{}` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_logging_s3_bucket_id"></a> [logging\_s3\_bucket\_id](#output\_logging\_s3\_bucket\_id) | The name of the logging bucket. |
