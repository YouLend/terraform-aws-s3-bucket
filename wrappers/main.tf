module "wrapper" {
  ...
  create_logging_bucket                               = try(each.value.create_logging_bucket, var.defaults.create_logging_bucket, false)
  ...
  logging_bucket_server_side_encryption_configuration = try(each.value.logging_bucket_server_side_encryption_configuration, var.defaults.logging_bucket_server_side_encryption_configuration, {})
  ...
  logging_bucket_name                                 = try(each.value.logging_bucket_name, var.defaults.logging_bucket_name, "")
  logging_bucket_list                                 = try(each.value.logging_bucket_list, var.defaults.logging_bucket_list, {})
}
